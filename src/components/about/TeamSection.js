...
const members = [
  {
    ...
    avatar: kevin,
    linkedin: "",
    bio: "He is a CEO, co-founder of AH99, AgencyHill99 projects",
  },
  {
    name: "Derek Smith",
  ...
  },
  {
    ...
    title: "Agency  Support Manager",
    avatar: vladimir,
    linkedin: "",
    bio: "He is a Agency  support manager",
  },
  {
    name: "Bhumish Shaw",
    ...
    <Box sx={{ py: 7, borderTop: 1, borderColor: "grey.100" }}>
      <Container>
        <Box sx={{maxWidth: '500px'}}>
          ...
          >
            Have you met the AH99 Founders Team?
          </Typography>
          <Typography 
            color="text.primary" 
            variant="h4" 
