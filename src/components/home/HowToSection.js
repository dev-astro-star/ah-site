...
const steps = [
  {
    ...
    description: '$AH99 is available in BSC, Binance Smart Chain networks. Choose your network from here BSC “DROP DOWN MENU” “Same as in toolbar” to participate in $AH99 pre-sale',
  },
  {
  ...
  },
  {
    ...
    description: 'You can currently swap BNB to $AH99 on Pre-Sale over AH99\'s official website! Pre-Sale supports only BEP20 BNB.',
  },
  {
    label: 'Swap BEP20 $BNB to $AH99',
    description: 'Click Connect Wallet Enter the amount of $BNB you would like to swap for $AH99. Then click on Swap.',
  },
  {
    label: 'Claim $AH99',
    description: 'All $AH99 purchased can be claimed at the pre-sale page after the end of the vesting period.',
  },
];
