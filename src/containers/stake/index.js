    ...
    <Fragment>
      <Container>
        <Box sx={{mb: 4}}>
          ...
          <Typography variant="body1" color="text.secondary">
            Stake $AH99 to earn more $AH99. You can stake $AH99 tokens in the staking pools to earn high APR as a return for holding $AH99 tokens.
          </Typography>
        </Box>
      </Container>
      <Box 
      ...
      >
        <Container className="fadeInUp">
          ...
          >
            Stake $AH99 tokens to earn rewards
          </Typography>
          <Typography 
